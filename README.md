...
```
# Site settings
title: hohoTT Blog             # title of your website
SEOTitle: hohoTT Blog			# check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: hohoTT     # modify this account to yours
weibo_username: 5334107562     # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-hohott.jpg     # use absolute URL.
```
...
It's possible that you want the two things different. For me, my site-title is **“hohoTT Blog”** but I want the title shows in search engine is **“黄玄的博客 | Hux Blog”** which is multi-language.
